...
class ExportService:
    ...
    def export_sensitivity_metrics_json(self, sensitivity_run: dict[str, object], scenarios: Iterable[dict[str, object]]) -> Path:
        ...
        payload = {
            ...
            "coverage_mode": sensitivity_run.get("coverage_mode"),
            "completion_status": sensitivity_run.get("completion_status"),
            "grid_version": sensitivity_run.get("grid_version"),
            "grid_hash": sensitivity_run.get("grid_hash"),
            "activation_grade_sensitivity": sensitivity_run.get("activation_grade_sensitivity"),
            "sensitivity_classification": sensitivity_run.get("sensitivity_classification"),
            "configured_grid_complete": sensitivity_run.get("configured_grid_complete"),
            "full_default_grid_complete": sensitivity_run.get("full_default_grid_complete"),
            "partial_grid_disclosure": sensitivity_run.get("partial_grid_disclosure"),
            "planned_scenario_count": sensitivity_run.get("planned_scenario_count"),
            "completed_scenario_count": sensitivity_run.get("completed_scenario_count"),
            "remaining_scenario_count": sensitivity_run.get("remaining_scenario_count"),
            "failed_required_scenario_count": sensitivity_run.get("failed_required_scenario_count"),
            "resume_token": sensitivity_run.get("resume_token"),
            "next_scenario_index": sensitivity_run.get("next_scenario_index"),
            "coverage_warnings": sensitivity_run.get("coverage_warnings") or [],
    ...
    def export_model_review_xlsx(self, report: dict[str, object]) -> Path:
        ...
        sheets = {
            ...
            "Sensitivity Reports": self._dict_table(report.get("sensitivity_reports")),
    ...
    def _sensitivity_scenario_row(self, scenario: dict[str, object], sensitivity_run_id: str) -> dict[str, object]:
        ...
        return {
            ...
            "grid_version": scenario.get("grid_version"),
            "grid_hash": scenario.get("grid_hash"),
    ...
    def _sensitivity_workbook_sheets(
        ...
        return {
            ...
            "Coverage Warnings": [["warning"], *[[warning] for warning in list(sensitivity_run.get("coverage_warnings") or [])]],
